...
<img
  className="block"
  src="/images/Create_AI_Agent_Sync_Your_Content.png"
  alt="Create AI Agent Sync Your Content"
/>
...
<img
  className="block"
  src="/images/Create_AI_Agent_Configure.png"
  alt="Create AI Agent Configure"
/>
