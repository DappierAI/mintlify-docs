...
<Steps>
    ...
    <Step title="Pick Data model from Marketplace">
        You can browse through different data models available in the [Dappier Marketplace](https://marketplace.dappier.com). You can select the data model that best fits your use case. Once selected get the data model id from the request endpoint. Data model id starts with dm_.
    </Step>
...
<CardGroup cols={2}>
    ...
    <Card title="Integrations" icon="link" href="https://docs.dappier.com/integrations">
    ...
    <Card title="RAG Marketplace" icon="comments-dollar" href="https://docs.dappier.com/rag-marketplace">
    ...
    <Card title="GPTs" icon="play" href="https://docs.dappier.com/real-time-data-openai-schema">
