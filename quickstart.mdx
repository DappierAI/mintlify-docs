...
<CardGroup cols={2}>
    ...
    <Card
        title="Integrations"
        icon="link"
        href="/integrations/introduction-integration"
    >
    ...
    <Card
        ...
        icon="globe"
        href="api-reference/endpoint/real-time-search"
    >
    ...
    <Card
        ...
        icon="thumbs-up"
        href="api-reference/endpoint/ai-recommendations"
    >
