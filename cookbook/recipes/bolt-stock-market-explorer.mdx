---
title: "✨ Build a Real-Time Stock Explorer App Using Dappier, Bolt.new, and Supabase"
---

This cookbook demonstrates how to build a **real-time stock market explorer** application using [Dappier](https://dappier.com/), [Bolt.new](https://bolt.new/), and [Supabase](https://supabase.com/)—a powerful trio that lets you generate, run, and deploy fullstack applications directly from the browser without requiring local setup.
...
### 🔐 Step 3: Configure Your Dappier API Key
...
Thank you — here is the corrected **Step 5**:
...
That’s it! Your real-time stock explorer is now live and powered by Dappier + Supabase.

![Bolt Stock Market Search](../../images/bolt-stock-market-search.png)

## 🌟 Highlights

This cookbook demonstrated how to build a real-time stock market explorer by combining **Bolt.new**, **Supabase**, and **Dappier**. It provides a fast, browser-based setup that showcases a practical application of AI-generated fullstack apps powered by real-time financial data.
