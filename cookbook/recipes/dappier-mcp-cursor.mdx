---
title: "⚙️ Integrate Dappier MCP with Cursor for AI-Powered Development
...
<iframe
  src="https://drive.google.com/file/d/1w/preview"
  width="100%"
  height="400"
  allowfullscreen
></iframe>
...
## Step 5: Configure Dappier MCP in Cursor
    ...
    ```
    Replace YOUR_API_KEY_HERE with your actual [Dappier API Keys](https://platform.dappier.com/profile/api-keys)
...
### Sample Queries & Expected Outputs
    ...
    #### 1️⃣ **User Query:**(dappier_real_time_search)
    ...
    #### 2️⃣ **User Query:**(dappier_ai_recommendations)
    ...
    #### 3️⃣ **User Query:**(dappier_real_time_search)
    ...
    #### 4️⃣ **User Query:** (dappier_real_time_search)
    ...
    #### 5️⃣ **User Query:** (dappier_ai_recommendations)
