---
title: "⚙️ Integrate Dappier MCP with 5ire for Real-Time AI-Powered Insights"
---
...
<iframe
  src="https://drive.google.com/file/d/1wvxO58HjWe9eYLuh5Ca5m1nc-Ca9KsuH/preview"
  width="100%"
  height="400"
  allowfullscreen
></iframe>
...
## Step 5: Configure Dappier MCP in 5ire
    ...
    - **Value**: _(Your API Key from Dappier)_
...
### Sample Queries & Expected Outputs
    ...
    #### 2️⃣ **User Query:**((dappier_real_time_search))
    ...
    #### 3️⃣ **User Query:**(dappier_ai_recommendations)
