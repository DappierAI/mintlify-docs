---
title: "🕸️ Build an AI-Powered Assistant with Anthropic MCP & Dappier"
---
...
<iframe
  src="https://drive.google.com/file/d/1zUBQUvZdX9XxQ3TB7yrD8AN8MjPAEOWT/preview"
  width="100%"
  height="400"
  allowfullscreen
></iframe>
...
<iframe
src="https://drive.google.com/file/d/16iKPojWanFuhGgSjoBf6bj2vv1J4GoGK/preview"
width="100%"
height="400"
allowfullscreen
...
2.Replace the contents of claude_desktop_config.json with the following:
...
1.Replace YOUR_API_KEY_HERE with your Dappier API Key.
...
Dappier MCP provides two core AI-powered tools that enable real-time data retrieval and AI-driven content recommendations. These tools allow Claude to fetch the latest insights from trusted sources, ensuring users receive accurate, real-time information across different domains.
    ...
    **Configuration Details**
    ...
    Tool Name: dappier_real_time_search
    ...
    **Configuration Details**
    ...
    Tool Name: dappier_ai_recommendations
