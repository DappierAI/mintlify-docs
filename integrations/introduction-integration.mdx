...
<CardGroup cols={2}>
    ...
    <Card
        title="Anthropic MCP"
        icon="microchip-ai"
        href="/integrations/anthropic-mcp-integration"
    >
    ...
    */}
    ...
    <Card
        ...
        icon="user-secret"
        href="/integrations/open-ai-agents-sdk-integration"
    >
...
<CardGroup cols={1}>
    ...
    <Card title="LlamaIndex" icon="code">
        Integrations with LlamaIndex and more LLMS coming soon. Stay tuned for
        updates.
    </Card>
</CardGroup>
