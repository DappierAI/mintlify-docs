...
<CardGroup cols={2}>
    ...
    <Card title="Anthropic MCP" icon="microchip-ai" href="/integrations/anthropic-mcp-integration">
       Connect LLMs with Dappier's real-time web Search, News, Sports, Financial Data, Crypto, and premium publisher content using Anthropic's Model Context Protocol.
    </Card>
