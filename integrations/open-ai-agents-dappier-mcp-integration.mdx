---
title: "Open AI Agents x Dappier MCP"
icon: "usb"
---
...
{/* TODO: Replace with real cookbook links. */}

-   **[Real-Time Financial News Agent](https://docs.dappier.com/cookbook/recipes/open-ai-agent-mcp-travel-assistant)** – Uses the Dappier MCP Server to provide **live stock market updates, financial insights, and earnings reports**.
-   **[AI Content Discovery Agent](https://docs.dappier.com/cookbook/recipes/open-ai-agent-content-recommender-mcp)** – An intelligent assistant for **news monitoring, personalized content discovery, and recommendation delivery** using Dappier’s AI-driven tools.
