...
{/* TODO: Update the langchain-dappier package url once the https://github.com/amaan-ai20/dappier-py repository is transferred under DappierAI. */}
| Retriever                                                                              | Self-host | Cloud offering |      Package      |
| :------------------------------------------------------------------------------------- | :-------- | :------------: | :---------------: |
| [DappierRetriever](https://python.langchain.com/docs/integrations/retrievers/dappier/) | ❌        |       ❌       |  langchain-dappier |
...
- data_model_id: str
    ...
    Multiple data model IDs are available and can be 
    found at: https://marketplace.dappier.com/marketplace
- k: int
    Number of documents to return. Defaults to 3.
- ref: Optional[str]
...
- search_algorithm: Literal[
    ...
    Search algorithm for retrieving articles. Defaults to "most_recent".
